...
use Pim\Bundle\CatalogBundle\Manager\ProductTemplateMediaManager;use Pim\Component\Catalog\Model\ProductValue;
...
class PimCatalogFileNormalizer extends AbstractMediaNormalizer
{
     ...
     */
    public function __construct($rootDir, ProductTemplateMediaManager $mediaManager)
    {
